...
func _Decode_GetUserById_Request(_ context.Context, r *http.Request) (interface{}, error) {
	var req transport.GetUserByIdRequest
	err := json.NewDecoder(r.Body).Decode(&req)
	return &req, err
}

func _Decode_GetUserById_Response(_ context.Context, r *http.Response) (interface{}, error) {
	var resp transport.GetUserByIdResponse
	err := json.NewDecoder(r.Body).Decode(&resp)
	return &resp, err
}

func _Encode_GetUserById_Request(ctx context.Context, r *http.Request, request interface{}) error {
	r.URL.Path = path.Join(r.URL.Path, "get-user-byid")
	return CommonHTTPRequestEncoder(ctx, r, request)
}

func _Encode_GetUserById_Response(ctx context.Context, w http.ResponseWriter, response interface{}) error {
