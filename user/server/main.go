...
import (
	...
	service "github.com/justyntemme/wp/user/service"
	transport "github.com/justyntemme/wp/user/transport"
	grpc "github.com/justyntemme/wp/user/transport/grpc"
	http "github.com/justyntemme/wp/user/transport/http"
...
func main() {
	...
	//protobuf.NewUserService("User Service", nil) // TODO: = service.NewUserService () // Create new service.
